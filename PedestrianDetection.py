        ...
        if count == 0:
            ...
            if success:
                for i, newbox in enumerate(boxes):
                    ...
                    print("{} {}".format(int(newbox[1]+newbox[3]//2),int(newbox[0]+newbox[2])))
                    ref_court = perspectiveT.draw_ref_point(int(newbox[1]+newbox[3]//2),int(newbox[0]+newbox[2]),H, ref_court_copy,frame)
                # print("showing image")
